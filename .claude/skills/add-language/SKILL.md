...
2. **성경 번역본 = YouVersion 판본 ID** (verbatim 기준). 후보가 여럿이면 AskUserQuestion 으로 확정.
   - 검증된 ID: en59·es149·pt-BR212·fr93·de51·ru400·ar13·ja1819·zh-Hant46·zh-Hans48·id306·vi193·th174·hi1683·tl399(MBB RTPV05)·ne1483(NNRV)·mn369(АБ2004)·my386·km85·uz1939·**ur189(URD)·si1794(SROV)·bn1681(BSI O.V.)·lo1727**.
   - 라이브에서 ID·책코드 실연결 확인 후 확정(`fetch-verse`로 구약절까지).
