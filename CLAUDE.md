...
- `YV` 버전ID(검증됨): en59·es149·pt-BR212·fr93·de51(Luther1912)·ru400·ar13·ja1819·zh-Hant46·zh-Hans48·id306·vi193·th174·hi1683·tl399·ne1483·mn369·my386·km85(KHCV 2005 គខប, 구약+신약 완전판).
...
## 현재 상태 (2026-06-18)
**20개 언어** 완성·배포됨(ko·en·ja·es·pt-BR·fr·de·ru·ar·hi·id·vi·th·zh-Hans·zh-Hant·tl·ne·mn·my·km). 작업 이력: ①13개 언어 본문 공식 번역본 대조 검수·수정 → ②보안헤더+캐시 → ③hreflang중복제거+keywords → ④SEO/AI(프리렌더+JSON-LD+llms.txt) → ⑤공유 적응형UI+PWA+GA4이벤트+QR → ⑥본문 구절 링크(ko 개역개정·나머지 YouVersion) → ⑦**외국인노동자 패키지 언어 추가: tl·ne·mn → my(미얀마, Judson YV386) → km(크메르, KHCV 2005 គខប YV85 완전판)**. km은 원문 바이트로 ZWNJ까지 절별 verbatim 대조 완료(v85 자체가 절마다 `ព្រះ‌ជាម្ចាស់`/`ព្រះ‌ជា‌ម្ចាស់` 비일관 → 인용절만 절별 원형에 맞춤, 산문은 자유). 모두 `main` 배포 완료. Google·Naver·Bing 등록+사이트맵 제출. 작업 트리 깨끗.
