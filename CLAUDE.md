...
- `tools/build-pages.mjs` — 언어별 정적 페이지 생성기(`index.html`을 템플릿으로 사용).
- 생성물(커밋 대상): `/<code>/index.html`(14개), `og.png`+`og-<code>.png`(15개), `sitemap.xml`.
- `vercel.json` (buildCommand=`node tools/build-pages.mjs`), `robots.txt`, `README.md`.
...
## 현재 상태 (2026-06-17)
15개 언어 완성·배포됨. 직전 작업: 13개 언어 본문을 공식 번역본과 대조 검수·수정해 `main` 배포 완료(커밋 `1d6f6d8`). 작업 트리 깨끗.
