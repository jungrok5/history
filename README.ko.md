...
- **언어 수 진행률: 약 127 / 7,396** (전체 목록은 사이트 🌐 메뉴)
...
## 다국어 (현재 약 127개 언어)
브라우저(OS) 언어를 자동 감지하며, 우측 상단 🌐에서 검색해 전환할 수 있습니다. 한국어·영어·중국어(간/번)·일본어·스페인어·포르투갈어·프랑스어·독일어·러시아어·아랍어·힌디어를 비롯해 **유럽·아시아·아프리카·태평양·중남미 전역 약 127개 언어**를 지원합니다. (전체 목록은 사이트 🌐 메뉴)
